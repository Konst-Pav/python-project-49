...
def generate_calc_question():
    ...
    math_oper = choice(LIST_OF_OPERATORS)
    question = str(random_num_1) + ' ' + str(math_oper) + ' ' + str(random_num_2)
    answer = calculate_expression(random_num_1, random_num_2, math_oper)
